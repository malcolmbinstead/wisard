...
@Component({
  ...
  template: `
    ...
    <p>A 'Score' shows how many RAM elements have detected a feature. </p>
    ...
    to the next letter in the testing set where its features
    will be reported.</p>

    <p>You will notice that immediately after teaching,
    the 'Score' window will be fully populated,
    ...
    some of the RAMs will not detect a feature and this will lower the Score,
    ...
    <div class="WBorder0">
      Score1<br />
      <div class="W2ScoreOut1 W8 H256 WBorder1"></div>
    </div>
...
export class Score1Component implements OnInit, OnDestroy {
  //
  ...
  log(theMessage: string) {
    this.theLog.add('Score1:' + theMessage);
  }
  //
}
