...
@Component({
  ...
  template: `
    ...
    <p>When using multiple Stores we want to know which one is showing the strongest response,
    this is used to decide what 'type' of scene is being observed.</p>

    <p>The 'Result' module looks for the classifier producing the strongest response,
    in addition to this it ensures that the strongest response exceeds a minimum threshold.</p>

    <p>The 'Result' module displays the chosen 'type' of scene.</p>
    ...
    <div class="WBorder0">
      Result<br />
      <div class="W3Result0 W64 H64 WBorder1"></div><br />
    </div>
...
export class ResultComponent implements OnInit, OnDestroy {
  ...
  log(theMessage: string) {
    this.theLog.add('Result:' + theMessage);
  }
  //
}
